...
export const RiskBadge = ({ priority }) => {
  ...
  const p = String(displayPriority).toUpperCase();
  ...
  if (p === 'CRITICAL') {
    ...
    styleClass =
      'bg-yellow-50 text-yellow-800 dark:bg-yellow-950/60 dark:text-yellow-300 border-yellow-200 dark:border-yellow-800';
